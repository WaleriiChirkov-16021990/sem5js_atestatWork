...
фотография, используя метод filter. Исходные данные - массив productsArray.
...
console.log(productsArray.filter(obj => obj.photos && obj.photos.length > 0));

function sortByProp(data, opder, prop) {
    let sorted = data.sort((a, b) => {
        return opder(a[prop], b[prop]);
    });
    return sorted;
}

console.log(sortByProp(productsArray, (a, b) => a - b, "price"));